...
static const struct tegra_emc_chip ventana_hynix_emc_chips[] = {
	{
...
static const struct tegra_emc_chip ventana_elpida_emc_chips[] = {
	{
		.description = "Elpida 300MHz",
		.mem_manufacturer_id = 0x0303,
...
{
	/* TODO: detect */
	tegra_init_emc(ventana_elpida_emc_chips, ARRAY_SIZE(ventana_elpida_emc_chips));
