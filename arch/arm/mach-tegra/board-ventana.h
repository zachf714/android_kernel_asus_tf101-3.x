...
#define MPU_ACCEL_IRQ_GPIO	TEGRA_GPIO_PN4 /* Disable ACCELIRQ: TEGRA_GPIO_PN4 */
#define MPU_ACCEL_ADDR		0x0F
#define MPU_ACCEL_BUS_NUM	0
#define MPU_ACCEL_ORIENTATION	{ 1, 0, 0, 0, 1, 0, 0, 0, 1 }  /* Orientation matrix for Kionix on ventana */
...
#define MPU_COMPASS_ORIENTATION	{ -1, 0, 0, 0, 1, 0, 0, 0, -1 }  /* Orientation matrix for AMI on ventana */

/*Orientation Definition of ASUS SL-101*/
#define SL101_GYRO_ORIENTATION		{ 0, 1, 0, -1, 0, 0, 0, 0, 1 }
#define SL101_ACCEL_ORIENTATION		{ -1, 0, 0, 0, 1, 0, 0, 0, -1 }
#define SL101_COMPASS_ORIENTATION	{ 1, 0, 0, 0, -1, 0, 0, 0, -1 }
